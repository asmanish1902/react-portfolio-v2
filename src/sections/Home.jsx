...
const Home = () => {
  ...
  const roles = useMemo(() => ["Full Stack Developer", "MERN Stack Developer", "React Developer", "Software Engineer"], []);
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-[40rem]">
            ...
            bg-gradient-to-r from-[#1cd8d2] to-[#00bf8f] drop-shadow-lg"
            ...
            <motion.p
              className="mt-6 text-base sm:text-md md:text-lg text-gray-300 max-w-2xl mx-auto lg-mx-0"
            ...
            <div className='mt-10 flex gap-5 text-2xl md:text-3xl justify-center lg:justify-start'>
              {
                socials.map(({ Icon, label, href }) => (
                  <motion.a href={href} key={label} target="_blank" aria-label={label}
        ...
        <div className='relative hidden lg:block'>
          ...
          ></div>
          <motion.img src={avator} alt="Manish Kumar"
            className='absolute top-1/2 -translate-y-1/2 object-contain select-none pointer-events-none'
            style={{ right: "-30px", width: "min(45vw, 780px)", maxHeight: "80vh" }}
